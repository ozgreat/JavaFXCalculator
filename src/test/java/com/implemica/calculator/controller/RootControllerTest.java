...
public class RootControllerTest extends ControllerTestUtils {
  ...
  @Test
  void boundaryTest() {
    String big = "1000000000000000^^^^^^^^^*10000000000^^^^^^^=*10000000000^^^^^^=*10000000000^^^^^=*10000000000=======" +
        "*1000000000=";

    String maxPossibleIntPart =big +"-1/1000000000000000^^^^^^^^^/1000000000000000^^^^^^^/1000000000000000^^^^" +
    ...
    //1.E-9999
    String theSmallestNumber = big + "R + 0 =";
  ...
  void mixOfOperations() {
    checkForBigFormula("300+5=%√-1000000000000000= ^ + 9999999999999999 R * 1000000000000000 / 50","sqr( -999999999999982.5 ) + 1/( 9999999999999999 ) 1.E-16 × 1000000000000000 ÷", "50");
    ...
    checkOperations("1 + 34 = C 123 ± + 3 % * -100 + 123.4 + 6 ^ - 90 R", "3.69 -3.69 - 100 + 123.4 + sqr( 6 ) 36 - 1/( 90 )","0.0111111111111111");
